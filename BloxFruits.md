                ...
                if _G.BringMon then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if _G.Auto_Bone2 and StartMagnetBoneMon2 then
                            if (v.HumanoidRootPart.Position - PosMonBone2.Position).Magnitude <= 300 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
...
elseif _G.oip == false then
    ...
    Misc:AddLabelRight("Dev : ball naja#3764")
        Setting:AddTextboxLeft("Music id","",function(a)
    end)
    _G.Volume = 1
   
    Setting:AddSliderLeft("Volume",1,10,_G.Volume,function(a)
    end)
    
    Setting:AddToggleLeft("laoped",_G.laoped,function(a)
    end)
    Setting:AddToggleLeft("Play Music",_G.PlayMusic,function(a)
    end)
    else
